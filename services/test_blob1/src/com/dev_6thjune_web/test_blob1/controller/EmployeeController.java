...
import com.dev_6thjune_web.test_blob1.service.EmployeeService;
 ...
 * @see Employee
 */
@RestController("test_blob1.EmployeeController")
@Api(value = "EmployeeController", description = "Exposes APIs to work with Employee resource.")
@RequestMapping("/test_blob1/Employee")
public class EmployeeController {

    private static final Logger LOGGER = LoggerFactory.getLogger(EmployeeController.class);

    @Autowired
	@Qualifier("test_blob1.EmployeeService")
