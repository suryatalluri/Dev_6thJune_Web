...
import com.dev_6thjune_web.test_blob1.service.Table1Service;
...
public class Table1Controller {
    ...
    public Table1 createTable1(MultipartHttpServletRequest multipartHttpServletRequest) {
    	Table1 table1 = WMMultipartUtils.toObject(multipartHttpServletRequest, Table1.class, "test_blob1"); 
    ...
    public Table1 editTable1(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) throws EntityNotFoundException {
        Table1 newTable1 = WMMultipartUtils.toObject(multipartHttpServletRequest, Table1.class, "test_blob1");
        newTable1.setId(id);
