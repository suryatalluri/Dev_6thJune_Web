...
import com.dev_6thjune_web.test_blob1.Table2;
import com.dev_6thjune_web.test_blob1.service.Table2Service;
...
public class Table2Controller {
    ...
    public Table2 createTable2(MultipartHttpServletRequest multipartHttpServletRequest) {
    	Table2 table2 = WMMultipartUtils.toObject(multipartHttpServletRequest, Table2.class, "test_blob1"); 
    ...
    public Table2 editTable2(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) throws EntityNotFoundException {
        Table2 newTable2 = WMMultipartUtils.toObject(multipartHttpServletRequest, Table2.class, "test_blob1");
        newTable2.setId(id);
