 ...
 * @see Table1
 */
@Service("test_blob1.Table1Service")
public class Table1ServiceImpl implements Table1Service {
    ...
    @Autowired
    @Qualifier("test_blob1.Table1Dao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service test_blob1 for table Table1 to {} format", exportType);
