 ...
 * @see Table2
 */
@Service("test_blob1.Table2Service")
public class Table2ServiceImpl implements Table2Service {
    ...
    @Autowired
    @Qualifier("test_blob1.Table2Dao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service test_blob1 for table Table2 to {} format", exportType);
