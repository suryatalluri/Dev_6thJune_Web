...
@Service
public class Test_blob1ProcedureExecutorServiceImpl implements Test_blob1ProcedureExecutorService {

    private static final Logger LOGGER = LoggerFactory.getLogger(Test_blob1ProcedureExecutorServiceImpl.class);

    @Autowired
    @Qualifier("test_blob1WMProcedureExecutor")
